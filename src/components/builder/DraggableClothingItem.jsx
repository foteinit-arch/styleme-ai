...
export default function DraggableClothingItem({ item, containerRef, onUpdate, onRemove }) {
  ...
  return (
    ...
    >
      ...
      {selected && (
        <div
          className={`absolute left-1/2 -translate-x-1/2 flex items-center gap-1 bg-white rounded-full shadow-lg px-2 py-1 border border-rose-100 z-[9999] ${item.y < 200 ? 'top-2' : '-top-8'}`}
          data-control="true"
