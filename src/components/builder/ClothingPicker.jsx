...
export default function ClothingPicker({ clothes, onDrop }) {
  ...
  return (
    <div className="p-3 flex flex-col h-full">
      <p className="text-sm font-semibold text-gray-700 mb-2">Your Clothes</p>
      <p className="text-xs text-gray-400 mb-3">Drag items onto your avatar</p>
        ...
        {CATEGORIES.map(c => (
          <button
            ...
            className={`px-2 py-0.5 rounded-full text-xs font-medium transition ${
              cat === c ? "bg-rose-500 text-white" : "bg-rose-50 text-rose-400 hover:bg-rose-100"
            }`}
          >
            {c}
          </button>
        ...
        {filtered.map(item => {
          ...
          return (
            <div
              ...
              onClick={() => onDrop(item)}
              className="bg-gray-50 border border-rose-100 rounded-xl overflow-hidden cursor-grab active:cursor-grabbing hover:border-rose-300 hover:shadow transition flex flex-col"
